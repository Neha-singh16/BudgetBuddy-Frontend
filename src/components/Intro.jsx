        ...
        <div className="grid gap-8 sm:gap-10 lg:grid-cols-2 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-2 rounded-full bg-white/10 border border-emerald-400/30 backdrop-blur">
              ...
              <span className="text-xs sm:text-sm font-semibold text-emerald-50">Smarter budgets. Calmer wallets.</span>
            </div>
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-emerald-100/90 max-w-2xl">
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4 text-xs sm:text-sm text-emerald-50/90">
              {[
                ...
                <motion.div
                  ...
                  className="rounded-lg sm:rounded-2xl bg-white/5 border border-emerald-300/20 px-2 sm:px-3 py-2 sm:py-3 backdrop-blur"
                >
          ...
          >
            ...
            <div className="relative bg-slate-950/60 border border-emerald-300/20 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 shadow-2xl backdrop-blur-xl overflow-hidden">
              <div className="flex items-center justify-between mb-3 sm:mb-4 gap-2">
                <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-400 flex items-center justify-center text-slate-900 font-bold text-sm sm:text-base flex-shrink-0">₹</div>
                  <div className="min-w-0">
                    <p className="text-xs sm:text-sm text-emerald-100/80">Monthly Outlook</p>
                    <p className="text-sm sm:text-lg font-bold text-white">Balanced & thriving</p>
                  </div>
                </div>
                <Sparkles className="text-emerald-200 w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0" />
              </div>
              ...
              <div className="space-y-2 sm:space-y-3">
                {["Housing", "Food", "Savings", "Leisure"].map((cat, idx) => {
                  ...
                  return (
                    <div key={cat} className="bg-white/5 border border-white/10 rounded-lg sm:rounded-2xl p-2 sm:p-3">
                      <div className="flex justify-between text-xs sm:text-sm text-emerald-50/80 mb-1.5">
                        <span>{cat}</span>
                        <span>{widths[idx]}</span>
                      </div>
                      <div className="h-2 sm:h-3 rounded-lg sm:rounded-xl bg-slate-800 overflow-hidden">
                        <motion.div
                          initial={{ width: 0 }}
        ...
        <div className="grid gap-4 sm:gap-6 md:gap-8 md:grid-cols-3">
          {[{
            ...
            <motion.div
              ...
              className="relative rounded-2xl sm:rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-4 sm:p-6 shadow-xl overflow-hidden"
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${card.gradient} opacity-70`} />
              <div className="relative space-y-2 sm:space-y-3 text-emerald-50">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-white/15 flex items-center justify-center text-white shadow-inner">
                  {card.icon}
                </div>
                <h3 className="text-base sm:text-lg md:text-xl font-bold text-white">{card.title}</h3>
                <p className="text-emerald-50/80 text-xs sm:text-sm leading-relaxed">{card.desc}</p>
